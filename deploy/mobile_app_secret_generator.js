...
function run(){
  try {
    var domain = readline.question("Please enter domain name of your instance (For ex: It should be dev.ejp.sunbird.org not https://dev.ejp.sunbird.org):");
